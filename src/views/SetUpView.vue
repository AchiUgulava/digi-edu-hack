...
const questions = ref([
  {
    id: 234,
    type: "question",
    content: "Thanks for registering, let's finish setting up your account. Please provide your timetable."
  },
  {
    id: 1234,
    type: "question",
    content: "Do you have any hobbies or activities outside of your study schedule?"
  },
  {
    id: 1234,
    type: "question",
    content: "Thanks for registering, if you have any other questions feel free to ask."
  }
]
);
const messages = ref([]);
...
<template>
  <LayoutAuthenticated>
    <SectionMain>
      ...
      <div class="fixed bottom-0 left-0 w-full bg-white dark:bg-slate-600 xl:pl-60">
        <SectionMain>
